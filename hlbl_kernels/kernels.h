...
void integrate_p1(double const *Pi, double *P1, int iflavor,  int const * gsw, unsigned VOLUME);
...
template <int kernel_n, int kernel_n_geom>
void compute_p23(double const *pi, double *P23, const int*gsw, int n_y, const int *gycoords, const double xunit[2],
QED_kernel_temps kqed_t, unsigned VOLUME);
int get_Lmax();
